...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/framework-4.0.0/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/framework-4.0.0/ruby' '--disable-rpath'"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2010-04-28"
